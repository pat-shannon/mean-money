...
describe("Spending Goals Page", () => {
    test("All text displays", async () => {
        ...
        await waitFor(() => {
            expect(screen.getByText("Let's see what we're working with")).toBeInTheDocument();
            expect(screen.getByText("How much would you like to try and spend per month on the following categories?")).toBeInTheDocument();
        });
